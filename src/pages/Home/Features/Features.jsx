...
const Features = () => {
    return (
        <section className="py-16 bg-base-100 w-full mx-auto px-4">
            ...
            {features.map((feature, index) => (
                <div
                    key={index}
                    className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-12 mb-12 bg-base-200 p-6 rounded-xl shadow"
                >
